  ...
  return (
    <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center mt-10 space-y-4">
      <img
        ...
        alt="Profile"
        className="w-36 h-36 rounded-full mx-auto border-4 border-blue-500 shadow-md"
      />
      <h1 className="text-4xl font-extrabold text-gray-800">Hi, I'm Jack Page</h1>
      <p className="text-lg text-gray-600">Full-Stack Developer | Computer Science Student</p>
    </section>
  );
}
